...
var GlobalStyles$1 = require('@mui/material/GlobalStyles');
...
var GlobalStyles__default = /*#__PURE__*/_interopDefaultLegacy(GlobalStyles$1);
...
const SettingsProvider = ({ children, pageSettings }) => {
    // ** State
    const [settings, setSettings] = React.useState(Object.assign({}, initialSettings));
    React.useEffect(() => {
    ...
    return (React__default["default"].createElement(SettingsContext.Provider, { value: { settings, saveSettings } }, children));
};
...
const ThemeToggleButton$1 = () => {
    ...
    return (React__default["default"].createElement(material.Button, { variant: "contained", onClick: () => {
...
const ThemeComponent = (props) => {
    ...
    let theme = styles.createTheme(coreThemeConfig);
    ...
    theme = styles.createTheme(theme, {
    ...
    return (React__default["default"].createElement(styles.ThemeProvider, { theme: theme },
        React__default["default"].createElement(CssBaseline__default["default"], null),
        React__default["default"].createElement(GlobalStyles__default["default"], { styles: () => GlobalStyles(theme) }),
        children));
};
...
Object.defineProperty(exports, 'styled', {
    enumerable: true,
    get: function () { return styles.styled; }
});
Object.defineProperty(exports, 'useTheme', {
    enumerable: true,
    get: function () { return styles.useTheme; }
});
exports.Button = ThemeToggleButton$1;
